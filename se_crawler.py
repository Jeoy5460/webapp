...
WebDriverWait(drv, delay).until(EC.presence_of_element_located((By.CLASS_NAME, "ets-ui-lesson-img")))
    
part = drv.find_element(By.CLASS_NAME,"ets-ui-lesson-img")
ActionChains(drv).move_to_element(part).click().perform()
